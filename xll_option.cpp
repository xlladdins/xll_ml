...
AddIn
    xai_option_cdf(Function(XLL_DOUBLE, L"xll_option_cdf", CATEGORY L".CDF")
                       .Arguments({
                       ...
                       .Category(CATEGORY)
                       .FunctionHelp(L"Return cumulative share distribution "
                                     L"function value of an option."));
...
AddIn xai_option_cgf(
    Function(XLL_DOUBLE, L"xll_option_cgf", CATEGORY L".CGF")
        ...
        .Category(CATEGORY)
        .FunctionHelp(
            L"Return cumulant generating function value of the model."));
...
AddIn xai_option_black_put(
    Function(XLL_DOUBLE, L"xll_option_black_put", CATEGORY L".BLACK.PUT")
        ...
        .Category(CATEGORY)
        .FunctionHelp(
            L"Return price of a European put option under the model."));
...
AddIn xai_option_bsm_put(
    Function(XLL_DOUBLE, L"xll_option_bsm_put", CATEGORY L".BSM.PUT")
        ...
        .Category(CATEGORY)
        .FunctionHelp(
            L"Return price of a European BSM put option under the model."));
double WINAPI xll_option_bsm_put(double r, double s0, double sigma, double k,
                                 double t, HANDLEX m) {
#pragma XLLEXPORT
  double result = NaN<double>;
